    ...
    <div className="flex justify-between p-2 md:mx-6 relative">
      {
        ...
        title="Menu"
        customFunc={() => setActiveMenu((previousState) => !previousState)}
        color={currentColor}
        icon={<AiOutlineMenu />}
      />:<div className=""></div>
      }
      <div className="flex">
        ...
        >
          <img className="rounded-full w-8 h-8" src={avatar} alt="profile-img" />
          <p>
            <span className="text-gray-400 text-14">Hi, </span>
            {" "}
            <span className="text-gray-400 font-bold ml-1 text-14">Shree</span>
